...
<body id="t" style="font-family: Roboto, sans-serif; font-size: 75%" jstcache="0" class="neterror">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      <div class="icon icon-generic" jseval="updateIconClass(this.classList, iconClass)" alt="" jstcache="1"></div>
      <div id="main-message" jstcache="0">
        <h1 jsselect="heading" jsvalues=".innerHTML:msg" jstcache="5">Chrome OS Malfunction</h1>
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2">Please press ESC+Reload+Power to clear local XML cache</p>
        ...
        <div class="error-code" jscontent="errorCode" jstcache="7">ERR_OS_NOT_FOUND</div>
...
</script><script jstcache="0">loadTimeData.data = {"details":"Details","disabledEasterEgg":"The owner of this device turned off the dinosaur game.","errorCode":"ERR_FILE_NOT_FOUND","fontfamily":"Roboto, sans-serif","fontsize":"75%","heading":{"hostName":"","msg":"Your file was not found"},"hideDetails":"Hide details","iconClass":"icon-generic","language":"en","suggestionsDetails":[],"suggestionsSummaryList":[],"summary":{"failedUrl":"file:///sfsdu","hostName":"","msg":"It may have been moved or deleted."},"textdirection":"ltr","title":"file:///sfsdu"};</script><script jstcache="0">// Copyright (c) 2012 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
